...
// assertEquals("<PH><html><ul><PH>", TemplateProcessor.getTokens(new Object(), template));
...
// assertEquals("<h1><PH>-<PH></h1>", TemplateProcessor.getTokens(new Object(), template));
...
// assertEquals("<h1>${other-placeholder}</h1>", TemplateProcessor.getTokens(new Object(), template));
...
// assertEquals("<h1>${other-placeholder}${other-placeholder}</h1>", TemplateProcessor.getTokens(new Object(), template));
...
// assertEquals("<h1>${other-placeholder}<PH></h1>", TemplateProcessor.getTokens(new Object(), template));
...
// assertEquals("<h1>${ <PH> }</h1>", TemplateProcessor.getTokens(new Object(), template));
