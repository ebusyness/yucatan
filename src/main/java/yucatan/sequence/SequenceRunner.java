	...
	public static String execute(String sequenceLocation) {
		...
		for (XmlTypeCommand commandDeclaration : commandsDeclaration) {
			...
			try {
				...
				log.error("Failed to cast the specified class (" + commandDeclaration.getName() + ") to represent a subclass of the class yucatan.Command in sequence ("
						+ sequenceLocation + "). Check the declaration of your methods and members - these should correspond with yucatan.Command.", e);
